...
parser.add_argument('--subsumptions', default='subsumptions-test.txt.gz', nargs='?', help='Path to the test subsumptions.')
parser.add_argument('--non_optimized', action='store_true', help='Disable most similar words calculation optimization.')
parser.add_argument('--threads', nargs='?', type=int, default=4, help='Number of threads.')
...
w2v = load_embeddings(os.path.join(WD, args['w2v']))
